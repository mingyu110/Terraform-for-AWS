...
# Calculate the Beijing Standard Time (BST) offset (8 hours)
bst_offset = timedelta(hours=8)

# Calculate the BST time by adding the offset to the UTC time
bst_now = utc_now + bst_offset

# Format the IST time in a human-readable format
bst_now_str = bst_now.strftime("%a, %d %b %Y %H:%M:%S +0800 BST")
    ...
    try:
        ...
        response = table.put_item(
            Item={
                ...
                'LatestGreetingTime': bst_now_str
            })
